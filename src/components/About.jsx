...
const About = ({ darkMode }) => {
  ...
  const values = [
    ...
    {
      title: "Innovation",
      description: "We embrace innovative solutions to meet evolving financial needs.",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          <div>
            ...
            <div className={`space-y-4 text-lg leading-relaxed ${
              ...
              <p>
                Founded with a vision to democratize access to quality financial services, 
                DANB Financial Consultancy Services has been at the forefront of business 
                financing solutions for over a decade.
              </p>
              <p>
                We understand that every business has unique financial needs, which is why 
                we offer personalized solutions ranging from collateral and non-collateral 
                loans to comprehensive financial planning and advisory services.
              </p>
              <p>
                Our commitment to fast approval processes, competitive rates, and exceptional 
                customer service has made us a trusted partner for hundreds of businesses 
                nationwide.
              </p>
            </div>
          </div>
