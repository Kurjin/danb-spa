  ...
  const services = [
    {
      ...
      description: "Comprehensive business financing solutions tailored to your company's growth needs. Fast approval process with competitive rates.",
      features: ["Working Capital", "Equipment Financing", "Expansion Loans", "Startup Funding"],
      color: "blue"
    },
    {
      icon: (
      ...
      description: "Secure loans backed by valuable assets. Lower interest rates and higher loan amounts with asset-backed security.",
      features: ["Real Estate", "Equipment", "Inventory", "Accounts Receivable"],
      color: "green"
    },
    {
      icon: (
      ...
      description: "Unsecured business loans based on creditworthiness and business performance. No asset requirements needed.",
      features: ["Credit-Based", "Revenue-Based", "Invoice Financing", "Merchant Cash Advances"],
      color: "purple"
    },
    {
      icon: (
      ...
      description: "Strategic financial planning and advisory services to optimize your business growth and profitability.",
      features: ["Cash Flow Management", "Investment Strategies", "Risk Assessment", "Tax Planning"],
      color: "yellow"
    },
    {
      icon: (
      ...
      description: "Expert financial consultation to help you make informed decisions for your business success.",
      features: ["Business Strategy", "Financial Analysis", "Market Research", "Growth Planning"],
      color: "red"
    },
    {
      icon: (
      ...
      description: "Professional investment guidance to maximize returns and build long-term wealth for your business.",
      features: ["Portfolio Management", "Market Analysis", "Risk Management", "Performance Tracking"],
      color: "indigo"
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                {/* Icon */}
                <div className={`w-16 h-16 rounded-xl ${colors.icon} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}>
                ...
                <div className="space-y-2">
                  {service.features.map((feature, featureIndex) => (
                    <div key={featureIndex} className="flex items-center">
                      <div className={`w-2 h-2 rounded-full ${colors.icon} mr-3`}></div>
        ...
        <div className={`mt-16 text-center p-8 rounded-2xl ${
          ...
          <p className={`mb-6 ${
            ...
            Contact our team today to discuss your financial needs and discover the best solutions for your business.
          </p>
